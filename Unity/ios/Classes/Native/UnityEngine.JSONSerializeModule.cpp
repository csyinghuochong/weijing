...
IL_0022:
	...
	}
	{
		...
		NullCheck(L_8);
		bool L_11;
		L_11 = VirtFuncInvoker1< bool, Type_t * >::Invoke(234 /* System.Boolean System.Type::IsSubclassOf(System.Type) */, L_8, L_10);
		G_B7_0 = ((int32_t)(L_11));
		goto IL_003d;
	}
...
IL_003d:
	...
	}
	{
		...
		NullCheck(L_13);
		String_t* L_14;
		L_14 = VirtFuncInvoker0< String_t* >::Invoke(24 /* System.String System.Reflection.MemberInfo::get_Name() */, L_13);
		String_t* L_15;
