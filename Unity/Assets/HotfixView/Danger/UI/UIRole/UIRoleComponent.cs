...
namespace ET
{
	...
	public static class UIRoleComponentSystem
	{
		...
		public static async ETTask OnButtonZodiac(this UIRoleComponent self)
		{
			...
			{
				FloatTipManager.Instance.ShowFloatTip(GameSettingLanguge.LoadLocalization("30级开启生肖系统喔！"));
				return;
			}
		...
		public static void InitSubView(this UIRoleComponent self)
		{
			...
			self.UIEquipSetComponent.ShowPlayerModel(bagInfo, userInfo.Occ, unit.GetComponent<NumericComponent>().GetAsInt(NumericType.EquipIndex), bagComponent.FashionEquipList);
