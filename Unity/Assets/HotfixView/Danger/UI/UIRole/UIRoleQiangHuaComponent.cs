...
namespace ET 
{
    ...
    public static class UIRoleQiangHuaComponentSystem
    {
        ...
        public static void OnUpdateQiangHuaUI(this UIRoleQiangHuaComponent self, int subType)
        {
            ...
            string qianghuaName = GameSettingLanguge.LoadLocalization(ItemViewHelp.EquipWeiZhiToName[subType].Name);
            ...
            self.Text_QiangHuaName.GetComponent<Text>().text = GameSettingLanguge.LoadLocalization(ItemViewHelp.EquipWeiZhiToName[subType].Name);
