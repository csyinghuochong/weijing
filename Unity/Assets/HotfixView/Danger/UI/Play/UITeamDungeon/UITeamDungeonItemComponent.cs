...
namespace ET
{
    ...
    public static class UITeamDungeonItemComponentSystem
    {
        ...
        {
            self.ZoneScene().GetComponent<TeamComponent>().SendTeamApply(self.TeamInfo.TeamId, self.TeamInfo.SceneId, self.TeamInfo.FubenType, self.TeamInfo.PlayerList[0].PlayerLv, true).Coroutine();
        }
        ...
        public static void OnUpdateUI(this UITeamDungeonItemComponent self, TeamInfo teamInfo)
        {
            ...
            self.Text_Name.GetComponent<Text>().text = teamDungeonConfig.GetName() + addStr;
