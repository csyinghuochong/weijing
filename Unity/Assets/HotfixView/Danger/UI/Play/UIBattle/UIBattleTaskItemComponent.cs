...
namespace ET
{
    public class UIBattleTaskItemComponent : Entity, IAwake<GameObject>, IDestroy
    {
    ...
    public class UIBattleTaskItemComponentDestroy : DestroySystem<UIBattleTaskItemComponent>
    {
        public override void Destroy(UIBattleTaskItemComponent self)
        {
