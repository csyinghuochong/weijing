    ...
    public static class UIPetInfoShowComponentSystem
    {
        ...
        public static void UpdateAttribute(this UIPetInfoShowComponent self, RolePetInfo rolePetInfo)
        {
            ...
            */
            ...
            self.PetZiZhiItemList[5].transform.Find("Text_ZiZhiValue").GetComponent<Text>().text = string.Format("{0}/{1}", UICommonHelper.ShowFloatValue_2(rolePetInfo.ZiZhi_ChengZhang), UICommonHelper.ShowFloatValue_2((float)petConfig.ZiZhi_ChengZhang_Max));
