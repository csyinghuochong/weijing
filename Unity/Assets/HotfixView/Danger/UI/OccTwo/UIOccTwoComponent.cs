...
namespace ET
{
    ...
    public static class UIOccTwoComponentSystem
    {
        ...
        public static void OnClickOccTwo(this UIOccTwoComponent self)
        {
            ...
            PopupTipHelp.OpenPopupTip(self.ZoneScene(), GameSettingLanguge.LoadLocalization("转职"), string.Format(GameSettingLanguge.LoadLocalization("是否转职为：{0}"), occupationTwoConfig.GetOccupationName()), () =>
            {
        ...
        public static void OnInitUI(this UIOccTwoComponent self)
        {
            ...
            self.Text_ZhiYe.GetComponent<Text>().text = occupationConfig.GetOccupationName();

            int[] OccTwoID = occupationConfig.OccTwoID;
            self.Text_ZhiYe_1.GetComponent<Text>().text = OccupationTwoConfigCategory.Instance.Get(OccTwoID[0]).GetOccupationName();
            self.Text_ZhiYe_2.GetComponent<Text>().text = OccupationTwoConfigCategory.Instance.Get(OccTwoID[1]).GetOccupationName();
            self.Text_ZhiYe_3.GetComponent<Text>().text = OccupationTwoConfigCategory.Instance.Get(OccTwoID[2]).GetOccupationName();
        ...
        public static void OnSelectZhiYe(this UIOccTwoComponent self, int occTwoId)
        {
            ...
            self.Text_ZhiYe_4.GetComponent<Text>().text = occupationTwoConfig.GetOccupationName();
