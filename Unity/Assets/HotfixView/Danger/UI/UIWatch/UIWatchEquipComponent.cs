...
namespace ET
{
    ...
    public class UIWatchEquipComponentAwake : AwakeSystem<UIWatchEquipComponent>
    {
        public override void Awake(UIWatchEquipComponent self)
        {
            ...
            self.UIEquipSetComponent2.Position = 5;
    ...
    public static class UIWatchEquipComponentSystem
    {
        public static void OnInitUI(this UIWatchEquipComponent self)
        {
            ...
            self.UIEquipSetComponent1.ShowPlayerModel(bagInfo, m2C_WatchPlayerResponse.Occ, 0, m2C_WatchPlayerResponse.FashionIds);
            ...
            BagInfo bagInfo2 = bagComponent.GetEquipBySubType(ItemLocType.ItemLocEquip, (int)ItemSubTypeEnum.Wuqi);
            self.UIEquipSetComponent2.ShowPlayerModel(bagInfo2, selfOcc, 0, self.ZoneScene().GetComponent<BagComponent>().FashionEquipList);
        }
    }
}
