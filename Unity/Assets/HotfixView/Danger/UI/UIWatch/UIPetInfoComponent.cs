...
namespace ET
{
    public class UIPetInfoComponent : Entity, IAwake, IDestroy
    {
    ...
    public class UIPetInfoComponentDestroy : DestroySystem<UIPetInfoComponent>
    {
    ...
    public class UIPetInfoComponentAwake : AwakeSystem<UIPetInfoComponent>
    {
        public override void Awake(UIPetInfoComponent self)
        {
            ...
            self.ButtonClose.GetComponent<Button>().onClick.AddListener(() => { UIHelper.Remove(self.ZoneScene(), UIType.UIPetInfo); });
    ...
    public static class UIPetInfoComponentSystem
    {
        ...
        public static void OnChangeNode(this UIPetInfoComponent self, int nodetype)
        {
        ...
        public static void OnButtonCloseAddPoint(this UIPetInfoComponent self)
        {
            self.OnChangeNode(1);
        }

        public static F2C_WatchPlayerResponse GetWatchPlayerInfo(this UIPetInfoComponent self)
        {
            UI uI = UIHelper.GetUI(self.ZoneScene(), UIType.UIWatch);
            return uI.GetComponent<UIWatchComponent>().F2C_WatchPlayerResponse;
        }

        public static void OnButtonPetHeXinItem(this UIPetInfoComponent self, int position)
        {
            ...
            self.PetHeXinSetComponent.UpdatePetHexinItem(self.PetHeXinList);
        }

        public static void OnClickPageButton(this UIPetInfoComponent self, int page)
        {
        ...
        public static async ETTask InitModelShowView_1(this UIPetInfoComponent self)
        {
            //模型展示界面
        ...
        public static async ETTask InitModelShowView_2(this UIPetInfoComponent self)
        {
            //模型展示界面
            long instanceId = self.InstanceId;
        ...
        public static RolePetInfo GetPetInfoByID(this UIPetInfoComponent self, long petId)
        {
        ...
        public static void OnClickPetHandler(this UIPetInfoComponent self)
        {
            self.PetSkinId = 0;
        ...
        public static BagInfo GetBagInfo(this UIPetInfoComponent self, long baginfoid)
        {
            for (int i= 0; i < self.PetHeXinList.Count; i++)
            {
                if (self.PetHeXinList[i].BagInfoID == baginfoid)
                {
                    return self.PetHeXinList[i];
                }
            }
            return null;
        }

        public static void UpdatePetHeXin(this UIPetInfoComponent self, RolePetInfo rolePetItem)
        {
            for (int i = 0; i < self.PetHeXinItemList.Length; i++)
            {
            ...
            for (int i = 0; i < rolePetItem.PetHeXinList.Count; i++)
            {
                ...
                itemTransform.Find("Node_2/TextName").gameObject.GetComponent<Text>().text = itemConfig.GetItemName();
        ...
        public static void UpdatePetSelected(this UIPetInfoComponent self, RolePetInfo rolePetItem)
        {
        ...
        public static void UpdatePetModel(this UIPetInfoComponent self, RolePetInfo rolePetItem)
        {
        ...
        public static async ETTask UpdateSkillList(this UIPetInfoComponent self, RolePetInfo rolePetInfo)
        {
            long instanceId = self.InstanceId;
        ...
        public static void UpdateExpAndLv(this UIPetInfoComponent self, RolePetInfo rolePetInfo)
        {
        ...
        public static void UpdateAttribute(this UIPetInfoComponent self, RolePetInfo rolePetInfo)
        {
        ...
        public static string GetAttributeShow(this UIPetInfoComponent self, RolePetInfo rolePetInfo, int numericType, float addValue)
        {
        ...
        public static void UpdateAttributeItem(this UIPetInfoComponent self, int index, GameObject itemObj, GameObject parentObj, string iconid, string value)
        {
        ...
        public static void UpdatePetZizhi(this UIPetInfoComponent self, RolePetInfo rolePetInfo)
        {
            ...
            self.PetZiZhiItemList[4].transform.Find("Text_ZiZhiValue").GetComponent<Text>().text = string.Format("{0}/{1}", UICommonHelper.ShowFloatValue_2(rolePetInfo.ZiZhi_ChengZhang), UICommonHelper.ShowFloatValue_2((float)petConfig.ZiZhi_ChengZhang_Max));
        ...
        public static async ETTask UpdatePetSkin(this UIPetInfoComponent self, RolePetInfo rolePetInfo)
        {
            if (self.LastSelectItem == null)
            {
                return;
        ...
        public static bool HavePetSkin(this UIPetInfoComponent self, int petid, int skinid)
        {
            return true;
        }

        public static void OnSelectSkinHandler(this UIPetInfoComponent self, int skinId)
        {
        ...
        public static void OnUpdatePetPoint(this UIPetInfoComponent self, RolePetInfo rolePetItem)
        {
        ...
        public static void OnUpdatePetInfo(this UIPetInfoComponent self, RolePetInfo rolePetInfo)
        {
