...
namespace ET
{
    ...
    public static class UIChouKaComponentSystem
    {
        ...
        public static void OnUpdateMianFeiTime(this UIChouKaComponent self)
        {
            ...
            self.Text_MianFeiTime_1.GetComponent<Text>().text = passTime_1 > cdTime_1 ? GameSettingLanguge.LoadLocalization("免费抽卡") : UICommonHelper.ShowLeftTime(cdTime_1 - passTime_1, GameSettingLanguge.Language);
            self.Text_MianFeiTime_2.GetComponent<Text>().text = passTime_2 > cdTime_2 ? GameSettingLanguge.LoadLocalization("免费抽卡") : UICommonHelper.ShowLeftTime(cdTime_2 - passTime_2, GameSettingLanguge.Language);
        }
