...
namespace ET
{
    public class UIStallSellComponent: Entity, IAwake, IDestroy
    {
    ...
    public class UIStallSellComponentDestroySystem : DestroySystem<UIStallSellComponent>
    {
        public override void Destroy(UIStallSellComponent self)
        {
    ...
    {
        public static void StoreUIdData(this UIStallSellComponent self)
        {
        ...
        public static void OnLanguageUpdate(this UIStallSellComponent self)
        {
            Transform tt = self.UIPageButton.GetParent<UI>().GameObject.transform;
