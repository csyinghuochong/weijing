...
namespace ET
{
    public class UIZhanQuLevelItemComponent : Entity, IAwake
    {
    ...
    public static class UIZhanQuLevelItemComponentSystem
    {
        //Par_1 条件    Par_2 人数    Par_3奖励 
        public static void OnInitUI(this UIZhanQuLevelItemComponent self, ActivityConfig activityInfo)
        {
        ...
        public static async ETTask OnButtonReceive(this UIZhanQuLevelItemComponent self)
        {
