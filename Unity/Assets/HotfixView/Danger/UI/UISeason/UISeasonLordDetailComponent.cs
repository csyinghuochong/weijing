...
namespace ET
{
    ...
    public static class UISeasonLordDetailComponentSystem
    {
        ...
        public static void UpdateInfo(this UISeasonLordDetailComponent self)
        {
            ...
            self.PositionText.GetComponent<Text>().text = string.Format(GameSettingLanguge.LoadLocalization("即将出现在{0}中..."), dungeonConfig.GetChapterName());
        ...
        public static void OnSelect(this UISeasonLordDetailComponent self, BagInfo bagInfo)
        {
            ...
            self.ItemDesText.GetComponent<Text>().text = itemConfig.GetItemDes();
