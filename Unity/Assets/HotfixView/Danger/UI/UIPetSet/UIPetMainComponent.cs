        ...
        public static void InitHpList(this UIPetMainComponent self)
        {
            ...
            for (int i = 0; i < entities.Count; i++)
            {
                ...
                if (camp == CampEnum.CampPlayer_1)
                {
                    ...
                    gameObject.transform.Find("Lal_Name").GetComponent<Text>().text = PetConfigCategory.Instance.Get(entities[i].ConfigId).GetPetName();
                ...
                if (entities[i].Type == UnitType.Monster)
                {
                    ...
                    gameObject.transform.Find("Lal_Name").GetComponent<Text>().text = monsterCof.GetMonsterName();
