...
namespace ET
{
    ...
    public class UIActivityV1LiBaoComponentAwake: AwakeSystem<UIActivityV1LiBaoComponent>
    {
        public override void Awake(UIActivityV1LiBaoComponent self)
        {
            ...
            self.TextScore = rc.Get<GameObject>("TextScore").GetComponent<Text>();
    ...
    public static class UIActivityV1LiBaoComponentSystem
    {
        ...
        public static void UpdateScore(this UIActivityV1LiBaoComponent self)
        {
            self.TextScore.text = self.ZoneScene().GetComponent<BagComponent>().GetItemNumber(37).ToString();
        }
    }
}