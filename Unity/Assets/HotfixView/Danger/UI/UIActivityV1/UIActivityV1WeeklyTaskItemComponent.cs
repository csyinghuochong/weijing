...
namespace ET
{
    public class UIActivityV1WeeklyTaskItemComponent : Entity, IAwake<GameObject>, IDestroy
    {
    ...
    public class UIActivityV1WeeklyTaskItemComponentAwake : AwakeSystem<UIActivityV1WeeklyTaskItemComponent, GameObject>
    {
        public override void Awake(UIActivityV1WeeklyTaskItemComponent self, GameObject gameObject)
        {
    ...
    public class UIActivityV1WeeklyTaskItemComponentDestroy : DestroySystem<UIActivityV1WeeklyTaskItemComponent>
    {
        public override void Destroy(UIActivityV1WeeklyTaskItemComponent self)
        {
    ...
    public static class UIActivityV1WeeklyTaskItemComponentSystem
    {
        public static void OnUpdateData(this UIActivityV1WeeklyTaskItemComponent self, TaskPro taskPro)
        {
        ...
        public static async ETTask OnGiveBtn(this UIActivityV1WeeklyTaskItemComponent self)
        {
        ...
        public static void UpdateSeasonDayTask(this UIActivityV1WeeklyTaskItemComponent self)
        {
            TaskPro taskPro = self.TaskPro;
            self.OnUpdateData(taskPro);
        }

        public static async ETTask OnBtn_Receive(this UIActivityV1WeeklyTaskItemComponent self)
        {
            ...
            {
                self.GetParent<UIActivityV1WeeklyTaskComponent>().UpdateTaskCountrys();
            }
        }
    }
}