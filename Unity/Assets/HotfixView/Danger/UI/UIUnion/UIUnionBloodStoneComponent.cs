...
namespace ET
{
    ...
    public static class UIUnionBloodStoneComponentSystem
    {
        public static void UpdateInfo(this UIUnionBloodStoneComponent self)
        {
            ...
            self.NameLText.GetComponent<Text>().text = publicQiangHuaConfig.GetEquipSpaceName();
            self.NameRText.GetComponent<Text>().text = publicQiangHuaConfig.GetEquipSpaceName();
