...
namespace ET
{
    ...
    public static class UIUnionApplyListItemComponentSystem
    {
        ...
        public static void OnUpdateUI(this UIUnionApplyListItemComponent self, UnionPlayerInfo unionPlayerInfo)
        {
            ...
            {
                self.Text_Occ.GetComponent<Text>().text = OccupationTwoConfigCategory.Instance.Get(unionPlayerInfo.OccTwo).GetOccupationName();
            }
            else
            {
                self.Text_Occ.GetComponent<Text>().text = OccupationConfigCategory.Instance.Get(unionPlayerInfo.Occ).GetOccupationName();
            }
        }
    }
}
