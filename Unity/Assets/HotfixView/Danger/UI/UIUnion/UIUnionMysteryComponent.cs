...
namespace ET
{
    ...
    public class UIUnionMysteryComponentDestroySystem : DestroySystem<UIUnionMysteryComponent>
    {
        public override void Destroy(UIUnionMysteryComponent self)
        {
    ...
    {
        public static void OnLanguageUpdate(this UIUnionMysteryComponent self)
        {
