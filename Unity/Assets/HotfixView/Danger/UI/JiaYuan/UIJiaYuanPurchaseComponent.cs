...
namespace ET
{
    ...
    public static class UIJiaYuanPurchaseComponentSystem
    {
        ...
        public static void ShowCDTime(this UIJiaYuanPurchaseComponent self)
        {
            ...
            self.Text_Time.GetComponent<Text>().text = string.Format(GameSettingLanguge.LoadLocalization("刷新倒计时: {0}"), UICommonHelper.ShowLeftTime(cdTime * 1000, GameSettingLanguge.Language));
        }
