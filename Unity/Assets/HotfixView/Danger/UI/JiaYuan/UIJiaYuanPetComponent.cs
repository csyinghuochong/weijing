...
namespace ET
{
    ...
    public class UIJiaYuanPetComponent : Entity, IAwake, IDestroy
    {
    ...
    public class UIJiaYuanPetComponentDestroySystem : DestroySystem<UIJiaYuanPetComponent>
    {
        public override void Destroy(UIJiaYuanPetComponent self)
        {
    ...
    {
        public static void OnLanguageUpdate(this UIJiaYuanPetComponent self)
        {
