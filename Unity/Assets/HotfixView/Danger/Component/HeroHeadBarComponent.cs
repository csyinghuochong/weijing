        ...
        public void OnLoadGameObject(GameObject gameObject, long formId)
        {
            ...
            switch (unit.Type)
            {
                case UnitType.Monster:
                    string imageHp = canAttack ? UICommonHelper.UI_pro_4_2 : UICommonHelper.UI_pro_3_2;
                ...
                case UnitType.Player:
                    imageHp = canAttack ? UICommonHelper.UI_pro_4_2: UICommonHelper.UI_pro_3_2;
                ...
                case UnitType.JingLing:
                    imageHp = canAttack ? UICommonHelper.UI_pro_4_2: UICommonHelper.UI_pro_3_4;
