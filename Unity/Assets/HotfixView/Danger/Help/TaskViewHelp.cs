    ...
    public class TaskViewHelp : Singleton<TaskViewHelp>
    {
        ...
        public bool ExcuteKillMonsterID(Scene domainscene, TaskPro taskPro, TaskConfig taskConfig)
        {
            ...
            if (mapComponent.SceneTypeEnum != SceneTypeEnum.LocalDungeon)
            {
                ...
                FloatTipManager.Instance.ShowFloatTip(GameSettingLanguge.LoadLocalization("请前往") + " " + DungeonConfigCategory.Instance.Get(fubenId).GetChapterName());
                return false;
            }
        ...
        public bool ExcuteMoveTo(Scene zoneScene, TaskPro taskPro, TaskConfig taskConfig)
        {
            ...
            if (!TaskHelper.HaveNpc(zoneScene, npcid))
            {
                ...
                if (fubenId == 0)
                {
                    ...
                    if (fubenId > 0)
                    {
                        fubenname = SceneConfigCategory.Instance.Get(fubenId).GetName();
                    }
                }
                else
                {
        ...
        public string GetDescKillMonsterID(TaskPro taskPro, TaskConfig taskConfig)
        {
            ...
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "击败{0} {1}/{2} {3}" : "击败<color=#EAFF39>{0} {1}/{2}</color> {3}";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            ...
            for (int i = 0; i < taskConfig.Target.Length; i++)
            {
                ...
                int fubenId = SceneConfigHelper.GetFubenByMonster(monsterId);
                fubenId = taskPro.FubenId > 0 ? taskPro.FubenId : fubenId;
                string fubenName = fubenId > 0 ? " (" + GameSettingLanguge.LoadLocalization("地图") + ":" + DungeonConfigCategory.Instance.Get(fubenId).GetChapterName() + ")" : "";
                MonsterConfig monsterConfig = MonsterConfigCategory.Instance.Get(monsterId);

                string text1 = "";
                if (i == 0)
                {
                    text1 = string.Format(progress, monsterConfig.GetMonsterName(), taskPro.taskTargetNum_1, taskConfig.TargetValue[i], fubenName);
                }
                if (i == 1)
                {
        ...
        public string GetDescLookingFor(TaskPro taskPro, TaskConfig taskConfig)
        {
            ...
            string text1 = string.Format(progress, npcConfig.GetName(), fubenName);
            return text1;
        }

        public string GetDescItemId(TaskPro taskPro, TaskConfig taskConfig)
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "寻找道具{0} {1}/{2}" : "寻找道具<color=#EAFF39>{0} {1}/{2}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            int itemId = taskConfig.Target[0];
            ItemConfig itemConfig = ItemConfigCategory.Instance.Get(itemId);
            string text1 = string.Format(progress, itemConfig.GetItemName(), taskPro.taskTargetNum_1, taskConfig.TargetValue[0]);
            return text1;
        }

        public string GetDescPlayerLv(TaskPro taskPro, TaskConfig taskConfig)
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "等级提升至{0}级 {1}/{2}" : "等级提升至<color=#EAFF39>{0}级 {1}/{2}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "击败任意怪物 {0}/{1}" : "击败任意怪物 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "击败任意领主级怪物 {0}/{1}" : "击败任意领主级怪物 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, taskConfig.TargetValue[0]);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "通关副本{0} {1}/{2}" : "通关副本<color=#EAFF39>{0} {1}/{2}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "进行转职{0} {1}/{2}" : "进行转职<color=#EAFF39>{0} {1}/{2}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string fubenName = "";
            string text1 = string.Format(progress, fubenName, taskPro.taskTargetNum_1, taskConfig.TargetValue[0]);
            return text1;
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "给予符合要求的道具 {0}/{1}" : "给予符合要求的道具 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "获得宠物数量 {0}/{1}" : "获得宠物数量 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "制造道具数量 {0}/{1}" : "制造道具数量 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "装备洗练次数 {0}/{1}" : "装备洗练次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "宠物天梯次数 {0}/{1}" : "宠物天梯次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "兑换金币次数 {0}/{1}" : "兑换金币次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "装备回收次数 {0}/{1}" : "装备回收次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "最大强化等级 {0}/{1}" : "最大强化等级 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "技能宠物 {0}/{1}" : "技能宠物 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(taskConfig.TargetValue[0] + tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "宠物探险通关{0} {1}/{2}" : "宠物探险通关<color=#EAFF39>{0} {1}/{2}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "消耗金币 {0}/{1}" : "消耗金币 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "击杀玩家数量 {0}/{1}" : "击杀玩家数量 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "家园等级 {0}/{1}" : "家园等级 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "宠物合成次数 {0}/{1}" : "宠物合成次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "拥有宠物数量 {0}/{1}" : "拥有宠物数量 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "给予一个宠物 {0}/{1}" : "给予一个宠物 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "使用普通藏宝图 {0}/{1}" : "使用普通藏宝图 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "使用高级藏宝图 {0}/{1}" : "使用高级藏宝图 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "封印之塔挑战 {0}/{1}" : "封印之塔挑战 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "使用药剂或者合剂次数 {0}/{1}" : "使用药剂或者合剂次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "获得X只新的宠物 {0}/{1}" : "获得X只新的宠物 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "合成1只战力达到X点的宠物 {0}/{1}" : "合成1只战力达到X点的宠物 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "宠物使用宠之晶洗炼宠物次数 {0}/{1}" : "宠物使用宠之晶洗炼宠物次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "在孵化系统中孵化成功宠物 {0}/{1}" : "在孵化系统中孵化成功宠物 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "在孵化系统中孵化指定的宠物蛋成功 {0}/{1}" : "在孵化系统中孵化指定的宠物蛋成功 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "宠物使用技能书次数 {0}/{1}" : "宠物使用技能书次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "宠物天梯战斗胜利次数 {0}/{1}" : "宠物天梯战斗胜利次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "使用N点品质的鉴定附魔道具给装备附魔 {0}/{1}" : "使用N点品质的鉴定附魔道具给装备附魔 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "使用N点品质的鉴定道具给装备鉴定 {0}/{1}" : "使用N点品质的鉴定道具给装备鉴定 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "鉴定装备时出一个大于N条属性的装备 {0}/{1}" : "鉴定装备时出一个大于N条属性的装备 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "洗炼出带有任何隐藏技能的装备 {0}/{1}" : "洗炼出带有任何隐藏技能的装备 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "洗炼出带有指定属性的装备 {0}/{1}" : "洗炼出带有指定属性的装备 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "增幅装备次数 {0}/{1}" : "增幅装备次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "试炼之地的输出排行榜进入前 {0}/{1}" : "试炼之地的输出排行榜进入前 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "宠物天梯进入排行榜前 {0}/{1}" : "宠物天梯进入排行榜前 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "战力排行榜进入前 {0}/{1}" : "战力排行榜进入前 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "家园烹饪次数 {0}/{1}" : "家园烹饪次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "家园种地种植次数 {0}/{1}" : "家园种地种植次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "家园种地收获次数 {0}/{1}" : "家园种地收获次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "家园牧场饲养次数 {0}/{1}" : "家园牧场饲养次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "家园牧场收货次数 {0}/{1}" : "家园牧场收货次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "家园美味品尝次数 {0}/{1}" : "家园美味品尝次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, 1);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "加入家族 {0}/{1}" : "加入家族 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress,  taskPro.taskTargetNum_1, taskConfig.TargetValue[0]);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "击败挑战级的 {0} {1}/{2}" : "击败挑战级的 <color=#EAFF39>{0} {1}/{2}</color>";

            string progress = GameSettingLanguge.LoadLocalization(tip);
            string monsterName = MonsterConfigCategory.Instance.Get(taskConfig.Target[0]).GetMonsterName();
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "击败地狱级的 {0} {1}/{2}" : "击败地狱级的 <color=#EAFF39>{0} {1}/{2}</color>";
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "通关挑战级-{0}副本 {1}/{2}" : "通关挑战级-<color=#EAFF39>{0}副本 {1}/{2}</color>";
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "通关地狱级-{0}副本 {1}/{2}" : "通关地狱级-<color=#EAFF39>{0}副本 {1}/{2}</color>";
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "击败挑战级任意怪物{0}/{1}" : "击败挑战级任意怪物<color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, taskConfig.TargetValue[0]);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "击败地狱级任意怪物{0}/{1}" : "击败地狱级任意怪物<color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, taskConfig.TargetValue[0]);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "击败挑战级任意领主怪物{0}/{1}" : "击败挑战级任意领主怪物<color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, taskConfig.TargetValue[0]);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "战力提升至{0}/{1}" : "战力提升至<color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, taskConfig.TargetValue[0]);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "通关试练塔{0}/{1}" : "通关试练塔<color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, taskConfig.TargetValue[0]);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "挑战深渊模式的副本 {0}/{1}" : "挑战深渊模式的副本 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, taskConfig.TargetValue[0]);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "组队副本伤害值 {0}/{1}" : "组队副本伤害值 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, taskConfig.TargetValue[0]);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "矿场占领次数 {0}/{1}" : "矿场占领次数 <color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, taskConfig.TargetValue[0]);
            return text1;
        }
        ...
        {
            string tip = taskPro.taskStatus == (int)TaskStatuEnum.Completed ? "击败地狱级任意领主怪物{0}/{1}" : "击败地狱级任意领主怪物<color=#EAFF39>{0}/{1}</color>";
            string progress = GameSettingLanguge.LoadLocalization(tip);
            string text1 = string.Format(progress, taskPro.taskTargetNum_1, taskConfig.TargetValue[0]);
            return text1;
        }
