...
namespace ET
{
    public class ErrorHelp:Singleton<ErrorHelp>
    {
        ...
        protected override void InternalInit()
        {
            ...
            ErrorHintList.Add(ErrorCore.ERR_RequestExitFuben, "请先退出副本");
            ...
            ErrorHintList.Add(ErrorCore.ERR_UnionChatLimit, "发消息太频繁 5秒1次");
            ...
            ErrorHintList.Add(ErrorCore.ERR_TurtleSupport_1, "同账号只能支持一次!");
            ...
            ErrorHintList.Add(ErrorCore.Pre_Condition_Error, "前置条件不足！");
        }
