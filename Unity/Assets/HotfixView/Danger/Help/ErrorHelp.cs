...
namespace ET
{
    public class ErrorHelp:Singleton<ErrorHelp>
    {
        ...
        protected override void InternalInit()
        {
            ...
            ErrorHintList.Add(ErrorCode.ERR_TeamDungeonTimesMax, "副本参与次数已经最大");
            ...
            ErrorHintList.Add(ErrorCode.ERR_PointNotEnough, "积分不足!");
            ...
            ErrorHintList.Add(ErrorCode.ERR_Union_NotLeader, "你不是族长"); 
            ...
            ErrorHintList.Add(ErrorCode.ERR_AlreadyReceived2, "已经领取过该批奖励");
            ...
            ErrorHintList.Add(ErrorCode.ERR_JiaYuanLevelMax, "已达最大等级！");
