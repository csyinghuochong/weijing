...
namespace ET
{
    ...
    public static class ItemViewHelp
    {
        ...
        public static Dictionary<int, NumericAttribute> AttributeToName = new Dictionary<int, NumericAttribute>()
        {
            ...
            { NumericType.Now_MaxAct, new NumericAttribute(){ Name = "攻击", Icon = "PetPro_2" , Float = false }  },
            { NumericType.Now_Mage, new NumericAttribute(){ Name = "魔法", Icon = "PetPro_3" , Float = false }  },
            { NumericType.Now_MaxDef, new NumericAttribute(){ Name = "物防", Icon = "PetPro_4" , Float = false }  },
            { NumericType.Now_MaxAdf, new NumericAttribute(){ Name = "魔防", Icon = "PetPro_5" , Float = false }  },

            { NumericType.Now_Cri, new NumericAttribute(){ Name = "暴击概率", Icon = "" , Float = true }  },
            { NumericType.Now_Res, new NumericAttribute(){ Name = "抗暴概率", Icon = "" , Float = true }  },
            { NumericType.Now_Hit, new NumericAttribute(){ Name = "命中概率", Icon = "" , Float = true }  },
            { NumericType.Now_Dodge, new NumericAttribute(){ Name = "闪避概率", Icon = "" , Float = true }  },
        };
