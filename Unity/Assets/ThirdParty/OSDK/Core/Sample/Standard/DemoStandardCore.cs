...
namespace Demo.Douyin.Game
{
    ...
    public class DemoStandardCore : MonoBehaviour
    {
        //【以下代码，外部方法】------------------------------------------------------------------
        ...
        private void InitSuccess()
        {
            ...
            ShowToastAndPrint("SDK初始化成功");
            
            //「可选」若接入授权模块，请在此处调用授权函数
            ReflectionInvoke.Invoke("Demo.Douyin.Game.DemoStandardDouyin", "Instance", "SetupAuthorize", null);
        }
        ...
        private void InitFail(BaseErrorEntity<InitErrorEnum> entity)
        {
            ...
            var msg = $"SDK初始化失败，code = {entity.ErrorEnum}, msg = ${entity.Message}";
        ...
        // 仅Demo使用函数
        public static DemoStandardCore Instance => DemoGameObjectUtils.GetOrCreateGameObject<DemoStandardCore>();
