...
namespace Demo.Douyin.Game
{
    ...
    /// 全官服促活分账
    /// </summary>
    public class DemoStandardDataLink : MonoBehaviour
    {
        //【以下代码，外部方法】------------------------------------------------------------------
        ...
        /// <param name="jsonParams">事件入参</param>
        /// <returns>接口调用是否成功</returns>
        ...
        {
            return OSDK.GetService<IDataLinkService>().UpdateCloudGameInfo(cloudGameInfo);
        }
        ...
        {
            ShowToastAndPrint("OnEventListener: eventName: " + eventListenerResult.EventName + 
        ...
        public static DemoStandardDataLink Instance => DemoGameObjectUtils.GetOrCreateGameObject<DemoStandardDataLink>();

        public static void ShowToastAndPrint(string message)
        {
            message = "全官服促活分账 " + message;
            DemoLog.D(message);
