...
namespace ET
{
    ...
    public static class ConfigHelper
    {
        ...
        {
            new KeyValuePair(){  Value = "青龙守护", Value2 = "200111;1" },                      //暴击
            new KeyValuePair(){  Value = "白虎守护", Value2 = "200411;1" },                      //抗暴
            new KeyValuePair(){  Value = "朱雀守护", Value2 = "200211;1" },                      //命中
            new KeyValuePair(){  Value = "玄武守护", Value2 = "200311;1" },                      //闪避
        };
