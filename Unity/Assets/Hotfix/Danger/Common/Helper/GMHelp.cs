...
namespace ET
{
    public static class GMHelp
    {
        ...
        public static Dictionary<long, string> PopUpPlayer = new Dictionary<long, string>()
        {
            ...
            { 2324766652299804677, "0@0@经过大数据排查，我们查询到您使用了违规操作，请主动加QQ群: 719546102 (联系群主) 我们收到消息会主动与你处理此事！" },// 661cafba01bc2ff3a137c7c9
            { 2287792326820560941, "0@0@经过大数据排查，我们查询到您使用了违规操作，请主动加QQ群: 719546102 (联系群主) 我们收到消息会主动与你处理此事！" },// 65fbd8a20a0f76c1447416c4
            { 2273154184922595334, "0@0@经过大数据排查，我们查询到您使用了违规操作，请主动加QQ群: 719546102 (联系群主) 我们收到消息会主动与你处理此事！" },// 65eed85ee053a67229c34371
            { 2279152553428058119, "0@0@经过大数据排查，我们查询到您使用了违规操作，请主动加QQ群: 719546102 (联系群主) 我们收到消息会主动与你处理此事！" },// 13357655503
            ...
            { 2273206875581382684, "0@0@经过大数据排查，我们查询到您使用了违规操作，请主动加QQ群: 719546102 (联系群主) 我们收到消息会主动与你处理此事！" },///65eed9dde053a67229c3485c
        };
