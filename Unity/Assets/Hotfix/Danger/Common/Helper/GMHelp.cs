...
namespace ET
{
    public static class GMHelp
    {
        ...
        public static Dictionary<long, string> PopUpPlayer = new Dictionary<long, string>()
        {
            ...
            { 2258568716503547909, "0@0@经过大数据排查，我们查询到您使用了第三方违规充值，请主动加QQ群: 719546102 (联系群主) 我们收到消息会主动与你处理此事！" },// { 2258574833828823040, "9@景沫渺@经过大数据排查，我们查询到您使用了第三方违规充值，请主动加QQ群: 719546102 (联系群主) 我们收到消息会主动与你处理此事！" },
