...
namespace ET
{
    public static class GMHelp
    {
        ...
        public static Dictionary<long, string> PopUpPlayer = new Dictionary<long, string>()
        {
            ...
            { 2274690580623720463, "0@0@经过大数据排查，我们查询到您使用了违规操作，请主动加QQ群: 719546102 (联系群主) 我们收到消息会主动与你处理此事！" }// 7345429395366173452
            { 2268768439197827077, "0@0@系统检测到你使用违规行为，请立即停止此行为，并联系群管理处理此事！" }// 18942352180
        };
