        ...
        public static List<ServerItem> GetServerList(bool innerNet, int zone)
        {
            ...
            if (innerNet)
            {
                ...
                else
                {
                    ...
                    serverItems_1.Add(new ServerItem() { ServerId = 8, ServerIp = "127.0.0.1:20365", ServerName = "先锋三区", ServerOpenTime = 0, Show = 0 });
                    serverItems_1.Add(new ServerItem() { ServerId = 9, ServerIp = "127.0.0.1:20375", ServerName = "先锋三区", ServerOpenTime = 0, Show = 0 });
                    serverItems_1.Add(new ServerItem() { ServerId = 10, ServerIp = "127.0.0.1:20385", ServerName = "先锋三区", ServerOpenTime = 0, Show = 0 });
                }
            }
            else
            {
                ...
                else
                {
                    ...
                    serverItems_1.Add(new ServerItem() { ServerId = 8, ServerIp = "39.96.194.143:20365", ServerName = "先锋四区", ServerOpenTime = 0, Show = 0 });
