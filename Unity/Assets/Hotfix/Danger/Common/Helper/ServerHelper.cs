...
namespace ET
{
    public static class ServerHelper
    {
        ...
        public static List<ServerItem> GetServerList(bool innerNet)
        {
            ...
            //2024/05/06 19:00:00 1714993200000 新区新区96
            serverItems_1.Add(new ServerItem() { ServerId = 96, ServerIp = $"{ip}:20545", ServerName = "新区新区", ServerOpenTime = 1714993200000, New = 0, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 20001 } });
