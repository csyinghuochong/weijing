    ...
    public static class ServerHelper
    {
        ...
        public static List<ServerItem> GetServerList(bool innerNet, int zone)
        {
            ...
            else
            {
                ...
                serverItems_1.Add(new ServerItem() { ServerId = 20, ServerIp = $"{ip}:20385", ServerName = "似水流年", ServerOpenTime = 1679050800000, Show = 0 });
                serverItems_1.Add(new ServerItem() { ServerId = 21, ServerIp = $"{ip}:20385", ServerName = "秋水人家", ServerOpenTime = 1679655600000, Show = 0 });
                ...
                serverItems_1.Add(new ServerItem() { ServerId = 25, ServerIp = $"{ip}:20375", ServerName = "灰烬使者", ServerOpenTime = 1682074800000, Show = 0 });
