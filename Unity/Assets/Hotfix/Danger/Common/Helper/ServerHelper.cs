    ...
    public static class ServerHelper
    {
        ...
        public static List<ServerItem> GetServerList(bool innerNet, int zone)
        {
            ...
            if (innerNet)
            {
                ...
                {
                    serverItems_1.Add(new ServerItem() { ServerId = 201, ServerIp = "127.0.0.1:20105", ServerName = "审核区", ServerOpenTime = 1662189906681, Show = 1 });
                }
                else
                {
            ...
            else
            {
                if (ComHelp.IsBanHaoZone(zone))
                {
                    serverItems_1.Add(new ServerItem() { ServerId = 201, ServerIp = "39.96.194.143:20105", ServerName = "审核区", ServerOpenTime = 1662189906681, Show = 1 });
                }
                else
                {
