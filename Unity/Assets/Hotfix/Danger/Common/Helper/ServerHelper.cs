...
namespace ET
{
    public static class ServerHelper
    {
        ...
        public static List<ServerItem> GetServerList(bool innerNet)
        {
            ...
            //2024/04/29 19:00:00 1714129200000  94
            serverItems_1.Add(new ServerItem() { ServerId = 94, ServerIp = $"{ip}:20505", ServerName = "新区新区", ServerOpenTime = 1714388400000, New = 0, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 20001 } });
