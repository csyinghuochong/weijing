    ...
    public static class ServerHelper
    {
        ...
        public static List<ServerItem> GetServerList(bool innerNet, int zone)
        {
            ...
            else
            {
                ...
                serverItems_1.Add(new ServerItem() { ServerId = 38, ServerIp = $"{ip}:20455", ServerName = "燃烧之刃", ServerOpenTime = 1689314400000, New = 1, Show = 1 });

                serverItems_1.Add(new ServerItem() { ServerId = 39, ServerIp = $"{ip}:20415", ServerName = "北海之都", ServerOpenTime = 1689937200000, New = 1, Show = 1 });
