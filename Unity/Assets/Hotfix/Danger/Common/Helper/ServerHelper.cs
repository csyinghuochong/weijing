    ...
    public static class ServerHelper
    {
        ...
        public static List<ServerItem> GetServerList(bool innerNet, int zone)
        {
            ...
            else
            {
                ...
                serverItems_1.Add(new ServerItem() { ServerId = 3, ServerIp = $"{ip}:20325", ServerName = "封测区", ServerOpenTime = 1662189906681, New = 0, Show = 1, PlatformList = new List<int>() { 0,1,2,3,4,5,6, 20001 } });
                ...
                serverItems_1.Add(new ServerItem() { ServerId = 62, ServerIp = $"{ip}:20375", ServerName = "新年快乐", ServerOpenTime = 1703847600000, New = 0, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 20001 } });
                serverItems_1.Add(new ServerItem() { ServerId = 63, ServerIp = $"{ip}:20415", ServerName = "万里华夏", ServerOpenTime = 1704427200000, New = 0, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 20001 } });
                ...
                serverItems_1.Add(new ServerItem() { ServerId = 65, ServerIp = $"{ip}:20495", ServerName = "天下无双", ServerOpenTime = 1705662000000, New = 0, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 20001 } });
                ...
                serverItems_1.Add(new ServerItem() { ServerId = 67, ServerIp = $"{ip}:20515", ServerName = "天空之城", ServerOpenTime = 1706243400000, New = 0, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 20001 } });
                ...
                serverItems_1.Add(new ServerItem() { ServerId = 69, ServerIp = $"{ip}:20535", ServerName = "勇者之路", ServerOpenTime = 1706871600000, New = 0, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 20001 } });
                ...
                serverItems_1.Add(new ServerItem() { ServerId = 73, ServerIp = $"{ip}:20575", ServerName = "恭喜发财", ServerOpenTime = 1708081200000, New = 0, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 20001 } });

                //2024/2/19 19:00 新区 龙凤呈祥
                serverItems_1.Add(new ServerItem() { ServerId = 74, ServerIp = $"{ip}:20585", ServerName = "龙凤呈祥", ServerOpenTime = 1708340400000, New = 1, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 20001 } });
            }
