    ...
    public static class ServerHelper
    {
        ...
        public static List<ServerItem> GetServerList(bool innerNet, int zone)
        {
            ...
            else
            {
                ...
                serverItems_1.Add(new ServerItem() { ServerId = 61, ServerIp = $"{ip}:20435", ServerName = "斗战胜佛", ServerOpenTime = 1703242800000, New = 0, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 20001 } });
                ...
                //2024/2/8 19:00 新区
                serverItems_1.Add(new ServerItem() { ServerId = 71, ServerIp = $"{ip}:20555", ServerName = "新区新区", ServerOpenTime = 1707476400000, New = 1, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 20001 } });
            }
