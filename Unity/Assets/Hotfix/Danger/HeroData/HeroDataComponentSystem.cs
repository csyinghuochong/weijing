...
namespace ET
{
    ...
    public static class HeroDataComponentSystem
    {
        ...
        public static void CheckNumeric(this HeroDataComponent self)
        {
            ...
            if (numericComponent.GetAsInt(NumericType.PetTupo_4) == 0 && petTupoList.ContainsKey(4) && petTupoList[4].Count > 0)
            {
                numericComponent.Set(NumericType.PetTupo_4, petTupoList[4][0].Id);
            }
