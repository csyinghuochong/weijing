...
namespace ET
{
    public class M2C_SoloDungeonHandle : AMHandler<M2C_SoloDungeon>
    {
        protected override void Run(Session session, M2C_SoloDungeon message)
        {
            ...
            EventType.UISoloRewardCreate.Instance.ZoneScene = session.ZoneScene();
            EventType.UISoloRewardCreate.Instance.m2C_SoloDungeon = message;
            EventSystem.Instance.PublishClass(EventType.UISoloRewardCreate.Instance);
