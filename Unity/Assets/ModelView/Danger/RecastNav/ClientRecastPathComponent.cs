...
namespace ET
{
    ...
    public class ClientRecastPathComponent : Entity, IAwake, ILoad
    {
        ...
        /// </summary>
        public Dictionary<int, ClientRecastPathProcessor> m_RecastPathProcessorDic = new Dictionary<int, ClientRecastPathProcessor>();
        ...
        public ClientRecastPathProcessor GetRecastPathProcessor(int mapId)
        {
        ...
        public void LoadMapNavData(int mapId, char[] navDataPath)
        {
            ...
            {
                ClientRecastPathProcessor recastPathProcessor = this.domain.AddChild<ClientRecastPathProcessor>();
        ...
        {
            m_RecastPathProcessorDic = new Dictionary<int, ClientRecastPathProcessor>();
            if (this.IsDisposed)
            {
                return;
            }
