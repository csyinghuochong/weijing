...
namespace ET
{
    public static class ServerHelper
    {
        ...
        public const string LogicServerGoogle = "8.221.110.80"; //"47.77.221.152";美国 //"47.86.59.101";香港    //"othercountry.weijinggame.com";
        ...
        public static void InitServerList(string startConfig)
        {
            ...
            if (startConfig.Contains("Localhost") || startConfig.Contains("Beta"))
            {
                ...
                serverItems_1.Add(new ServerItem() { ServerId = 183, ServerIp = $"{ip}:20415", ServerName = "圣光神域", ServerOpenTime = 1763722800000, New = 0, Show = 0, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 8, 100, 20001 } });
                ...
                serverItems_1.Add(new ServerItem() { ServerId = 193, ServerIp = $"{ip}:20495", ServerName = "精灵之森", ServerOpenTime = 1769770800000, New = 0, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 8, 100, 20001 } });
                ...
                //2026/02/13 19:00:00 1770980400000 合区 xx - xx   xx/xx
                //2026/02/13 19:00:00 1770980400000 新区 新区195 195
                serverItems_1.Add(new ServerItem() { ServerId = 195, ServerIp = $"{ip}:20565", ServerName = "新区195", ServerOpenTime = 1770980400000, New = 0, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 8, 100, 20001 } });
            }
