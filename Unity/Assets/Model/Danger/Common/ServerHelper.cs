    ...
    public static class ServerHelper
    {
        ...
        public static void InitServerList(string startConfig)
        {
            ...
            if (startConfig.Contains("Localhost") || startConfig.Contains("Beta"))
            {
                ...
                //2025/11/14 19:00:00 1763118000000 合区 xx-xx   xx/xx
                //2025/11/14 19:00:00 1763118000000 新区 新区新区 182
                serverItems_1.Add(new ServerItem() { ServerId = 182, ServerIp = $"{ip}:20415", ServerName = "新区新区", ServerOpenTime = 1763118000000, New = 0, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 8, 100, 20001 } });
            }
