    ...
    public static class ServerHelper
    {
        ...
        public static void InitServerList(string startConfig)
        {
            ...
            if (startConfig.Contains("Localhost") || startConfig.Contains("Beta"))
            {
                ...
                //2025/12/19 19:00:00 1766142000000 合区 风暴之地 - 巨刃降临   178/179
                ...
                serverItems_1.Add(new ServerItem() { ServerId = 179, ServerIp = $"{ip}:20565", ServerName = "巨刃降临", ServerOpenTime = 1761303600000, New = 0, Show = 0, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 8, 100, 20001 } });
                ...
                //2026/01/02 19:00:00 1767351600000 合区 xx - xx   xx/xx
                //2026/01/02 19:00:00 1767351600000 新区 新区新区 189
                serverItems_1.Add(new ServerItem() { ServerId = 189, ServerIp = $"{ip}:20445", ServerName = "新区新区", ServerOpenTime = 1767351600000, New = 0, Show = 1, PlatformList = new List<int>() { 0, 1, 2, 3, 4, 5, 6, 8, 100, 20001 } });
            }
