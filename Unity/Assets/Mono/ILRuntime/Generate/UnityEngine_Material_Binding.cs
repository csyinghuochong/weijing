...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Material_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_mainTexture_0);
            args = new Type[]{};
            method = type.GetMethod("get_mainTexture", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_mainTexture_1);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("GetTextureOffset", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, GetTextureOffset_2);
            args = new Type[]{typeof(System.String), typeof(UnityEngine.Vector2)};
            method = type.GetMethod("SetTextureOffset", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, SetTextureOffset_3);


        }


        static StackObject* set_mainTexture_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* get_mainTexture_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* GetTextureOffset_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* SetTextureOffset_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
