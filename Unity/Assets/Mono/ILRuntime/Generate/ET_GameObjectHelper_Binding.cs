...
{
    unsafe class ET_GameObjectHelper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            MethodBase method;
            Type[] args;
            Type type = typeof(ET.GameObjectHelper);
        ...
        static StackObject* Get_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ET.GameObjectHelper.Get<UnityEngine.GameObject>(@gameObject, @key);
        ...
        static StackObject* Get_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ET.GameObjectHelper.Get<UnityEngine.TextAsset>(@gameObject, @key);
