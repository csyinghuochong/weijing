...
{
    unsafe class System_Threading_Tasks_Task_1_HttpResponseMessage_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Threading.Tasks.Task<System.Net.Http.HttpResponseMessage>);
            args = new Type[]{};
