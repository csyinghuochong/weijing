...
{
    unsafe class ET_ETTask_1_SceneAssetRequest_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(ET.ETTask<libx.SceneAssetRequest>);
            args = new Type[]{};
        ...
        static StackObject* GetAwaiter_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            ET.ETTask<libx.SceneAssetRequest> instance_of_this_method = (ET.ETTask<libx.SceneAssetRequest>)typeof(ET.ETTask<libx.SceneAssetRequest>).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* Create_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = ET.ETTask<libx.SceneAssetRequest>.Create(@fromPool);
