...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_TimeHelper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, ShowLeftTime_3);
            args = new Type[]{typeof(System.Int64), typeof(System.Int32)};
            method = type.GetMethod("TimeToShowCostTimeStr", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, TimeToShowCostTimeStr_4);
            ...
            app.RegisterCLRMethodRedirection(method, ShowTimeDifferenceStr_5);
            args = new Type[]{};
            method = type.GetMethod("ClientFrameTime", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ClientFrameTime_6);
        ...
        static StackObject* ShowLeftTime_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static StackObject* TimeToShowCostTimeStr_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* ShowTimeDifferenceStr_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* ClientFrameTime_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* __ret = ILIntepreter.Minus(__esp, 0);
