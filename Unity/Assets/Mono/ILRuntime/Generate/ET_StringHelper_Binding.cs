...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_StringHelper_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            method = type.GetMethod("IsSpecialChar", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, IsSpecialChar_1);
            args = new Type[]{typeof(System.String)};
            method = type.GetMethod("ToUtf8", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, ToUtf8_2);
        ...
        static StackObject* IsSpecialChar_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
            ...
            var result_of_this_method = ET.StringHelper.IsSpecialChar(@str);
        ...
        static StackObject* ToUtf8_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
