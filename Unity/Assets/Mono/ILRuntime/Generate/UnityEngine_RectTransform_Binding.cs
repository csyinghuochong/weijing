...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_RectTransform_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_offsetMax_0);
            args = new Type[]{typeof(UnityEngine.Vector2)};
            method = type.GetMethod("set_offsetMin", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_offsetMin_1);
            args = new Type[]{typeof(UnityEngine.Vector2)};
            ...
            app.RegisterCLRMethodRedirection(method, get_rect_3);
            args = new Type[]{};
            method = type.GetMethod("get_sizeDelta", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_sizeDelta_4);
            args = new Type[]{typeof(UnityEngine.Vector2)};
        ...
        static StackObject* set_offsetMax_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
        ...
        static StackObject* set_offsetMin_1(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* get_rect_3(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
        ...
        static StackObject* get_sizeDelta_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
