...
namespace ILRuntime.Runtime.Generated
{
    unsafe class UnityEngine_Camera_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, set_orthographicSize_5);
            args = new Type[]{};
            method = type.GetMethod("get_orthographicSize", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, get_orthographicSize_6);
            args = new Type[]{typeof(System.Single)};
            method = type.GetMethod("set_fieldOfView", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_fieldOfView_7);
            args = new Type[]{typeof(UnityEngine.Vector3)};
        ...
        static StackObject* set_orthographicSize_5(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
        ...
        static StackObject* get_orthographicSize_6(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
        ...
        static StackObject* set_fieldOfView_7(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
