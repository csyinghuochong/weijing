...
{
    unsafe class System_Net_Http_FormUrlEncodedContent_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(System.Net.Http.FormUrlEncodedContent);
