...
namespace ILRuntime.Runtime.Generated
{
    unsafe class ET_TimeInfo_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRMethodRedirection(method, ToDateTime_0);
            args = new Type[]{typeof(System.Int64)};
            ...
            method = type.GetMethod("set_TimeZone", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, set_TimeZone_2);
            args = new Type[]{};
        ...
        static StackObject* ToDateTime_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.ToDateTime(@timeStamp);
        ...
        static StackObject* set_TimeZone_2(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 2);
            ...
            instance_of_this_method.TimeZone = value;
