...
namespace ET
{
    ...
    public static class PetComponentSystem
    {
        ...
        public static void UpdatePetAttribute(this PetComponent self, RolePetInfo rolePetInfo, Unit petUnit = null)
        {
            ...
            int act_Now = (int)((petCof.Base_Act + rolePetInfo.PetLv * petCof.Lv_Act + pro_LiLiang * 4) * actPro);
            int mage_Now = (int)((petCof.Base_MageAct + rolePetInfo.PetLv * petCof.Lv_MageAct + pro_ZhiLi * 4) * magePro);
            int hp_Now = (int)((petCof.Base_Hp + rolePetInfo.PetLv * petCof.Lv_Hp + pro_TiZhi * 25) * hpPro);
            int def_Now = (int)((petCof.Base_Def + rolePetInfo.PetLv * petCof.Lv_Def + pro_NaiLi * 5 + pro_LiLiang * 1) * defPro);
            int adf_Now = (int)((petCof.Base_Adf + rolePetInfo.PetLv * petCof.Lv_Adf + pro_NaiLi * 5 + pro_ZhiLi * 1) * adfPro);
