    ...
    public static class FriendHelper
    {
        ...
        public static async ETTask<List<FriendInfo>> GetFriendInfos(long dbCacheId, long gateServerId,  List<long> friends)
        {
            ...
            for (int i = 0; i < friends.Count; i++)
            {
                ...
                D2G_GetComponent d2GGetUnit = (D2G_GetComponent)await ActorMessageSenderComponent.Instance.Call(dbCacheId, new G2D_GetComponent() { CharacterId = friendId, Component = DBHelper.UserInfoComponent });
