...
namespace ET
{
    ...
    public class PlayerOfflineOutTimeComponentAwakeSystem : AwakeSystem<PlayerOfflineOutTimeComponent>
    {
        public override void Awake(PlayerOfflineOutTimeComponent self)
        {
            ...
            //掉线两分钟后踢下线
            self.Timer = TimerComponent.Instance.NewOnceTimer(TimeHelper.ServerNow() + ActorLocationSenderComponent.TIMEOUT_TIME - 1000, TimerType.PlayerOfflineOutTime, self);
        }
    }
